...
void main() {
  ...
  group('Onboarding Flow Tests', () {
    testWidgets(
      'First launch loads OnboardingScreen via AppOnboardingGateway',
      (tester) async {
    ...
    testWidgets('Subsequent launch bypasses OnboardingScreen when completed', (
      tester,
    ) async {
      SharedPreferences.setMockInitialValues({
    ...
    testWidgets(
      'Navigating through Onboarding pages and selecting Intermediate skill level',
      (tester) async {
        await tester.pumpWidget(
          ProviderScope(
            child: MaterialApp(
