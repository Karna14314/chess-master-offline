...
void main() {
  ...
  group('Section 11 — Stockfish Native Crash Prevention (FEN Validation)', () {
    ...
    test('Valid FEN strings pass validation and return move', () async {
      ...
      final res1 = await service.getBestMove(
        fen: validStartPos,
        depth: 1,
        thinkTimeMs: 100,
      );
      ...
      final res2 = await service.getBestMove(
        fen: validEndgame,
        depth: 1,
        thinkTimeMs: 100,
      );
    ...
    test(
      'Malformed or invalid FENs are rejected by validation and use fallback safely',
      () async {
        ...
        const badEnPassant =
            'rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq invalid 0 1';
        ...
        final res2 = await service.getBestMove(
          fen: missingWhiteKing,
          depth: 1,
          thinkTimeMs: 100,
        );
        expect(res2.bestMove, isNotNull);

        final res3 = await service.getBestMove(
          fen: badBoardRows,
          depth: 1,
          thinkTimeMs: 100,
        );
        ...
        final res4 = await service.getBestMove(
          fen: badEnPassant,
          depth: 1,
          thinkTimeMs: 100,
        );
